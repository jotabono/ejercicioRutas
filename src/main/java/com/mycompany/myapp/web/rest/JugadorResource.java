...
public class JugadorResource {
    ...
    @RequestMapping(value = "/jugadors/canastas/{numCanastas}",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<List<Jugador>> getByNumCanastas(@PathVariable int numCanastas) throws URISyntaxException{

        List<Jugador> readings = jugadorRepository.findByXCanastas(numCanastas);
